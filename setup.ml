...
(* OASIS_START *)
(* DO NOT EDIT (digest: d4e2c5cac0cf732b64f6c3a8c9aa77c5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/pqwy/effective";
          synopsis = "XXX";
          description = Some [OASISText.Para "XXX"];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["S"; "Eff"; "Stacked"; "Local"; "Univ"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\233\005l\026\147\203#\180\\Q\140\147\127h\157\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
